...
//	    		wb.ImplicitlyWait(driver);
	    ...
	    @AfterMethod
	    // Method to navigate back until "Dashboard" is visible
	    public void navigateBackUntilDashboard() {
	    	{
	    		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	    		    ...
	    		    while (backPressCount < maxBackPresses) {
	    		        try {
	    		            ...
	    		            // If element is found and is visible, quit the app
	    		            if (dashboardText.isDisplayed()) {
	    		                System.out.println("Dashboard is visible. Quitting app...");
